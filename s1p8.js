...
function solution (height1, height2, height3, height4, height5, height6, height7, height8, height9) {
    const MAX_HEIGHT_SUM = 100;
    const heights = [height1, height2, height3, height4, height5, height6, height7, height8, height9];
...
function main () {
    ...
    const input8 = 8;
    const input9 = 13;
    const output = this.solution(input1, input2, input3, input4, input5, input6, input7, input8, input9);
    console.log("S1P8\n");
    // test();
    console.log(`Input: ${input1} ${input2} ${input3} ${input4} ${input5} ${input6} ${input7} ${input8} ${input9}`);
