/**
 * Title: 광고 삽입
 * Content: 카카오TV에서 유명한 크리에이터로 활동 중인 죠르디는 환경 단체로부터 자신의 가장 인기있는 동영상에 지구온난화의 심각성을 알리기 위한 공익광고를 넣어 달라는 요청을 받았습니다.
 ...
 *                                                      01:30:59    01:53:29
 *                               | ----2----|              | ---X--- |
 *                           00:40:31    01:00:00       01:30:59  01:45:14
 *          | -------------------------------------------------------------------|
 *       00:00:00                                                             02:03:55
 *                      | ----3---- |               | ----1---- |
 *                  00:25:50       00:48:29      01:20:15    01:45:14
 *                                                            | ----5---- |
 *                                                         01:37:44    02:02:30
 *
 *          * 그림의 가운데 선은 광고를 검토 중인 "죠르디" 동영상의 전체 재생 구간을 나타냅니다.
 *            위 그림에서, "죠르디" 동영상의 총 재생시간은 02시간 03분 55초 입니다.
 *          * 그림의 번호가 있는 선들은 각 시청자들이 "죠르디"의 동영상을 재생한 구간의 위치를 표시하고 있습니다.
 *            선의 가운데 숫자는 각 재생 기록을 구분하는 ID를 나타냅니다.
 *            선에 표기된 왼쪽 끝 숫자와 오른쪽 끝 숫자는 시청자들이 재생한 동영상 구간의 시작 시각과 종료 시각을 나타냅니다.
 ...
 *          * 그림의 X가 있는 선은 "죠르디"가 선택한 최적의 공익광고 위치를 나타냅니다.
 ...
 * Input Condition: * play_time, adv_time은 길이 8로 고정된 문자열입니다.
 ...
 * Output Condition: 공익광고를 삽입할 시각을 HH:MM:SS 형식의 8자리 문자열로 반환합니다.
 * Input Example: play_time = "02:03:55"
 *                adv_time = 	"00:14:15"
 *                logs = ["01:20:15-01:45:14", "00:40:31-01:00:00", "00:25:50-00:48:29", "01:30:59-01:53:29", "01:37:44-02:02:30"]
 * Output Example: "01:30:59"
 */
// *다시 풀기

{
  ...
  function testToExample1() {
    const testNum = 1;
    const inputPlayTime = "99:59:59";
    const inputAdvTime = "25:00:00";
    const inputLogs = [
      "69:59:59-89:59:59",
      "01:00:00-21:00:00",
      "79:59:59-99:59:59",
    ...
    const expectResult = "01:00:00";
    const testFunction = solution;
    const condition =
      testFunction(inputPlayTime, inputAdvTime, inputLogs) === expectResult;
    validateTestResult(testNum, condition);
  }

  function testToExample2() {
    const testNum = 2;
    const inputPlayTime = "50:00:00";
    const inputAdvTime = "50:00:00";
    const inputLogs = [
      "15:36:51-38:21:49",
      "10:14:18-15:36:51",
      "38:21:49-42:51:45",
    ];
    const expectResult = "00:00:00";
    const testFunction = solution;
    const condition =
      testFunction(inputPlayTime, inputAdvTime, inputLogs) === expectResult;
    validateTestResult(testNum, condition);
  ...
  function main() {
    ...
    const inputPlayTime = "02:03:55";
    const inputAdvTime = "00:14:15";
    const inputLogs = [
      "01:20:15-01:45:14",
      "00:40:31-01:00:00",
      "00:25:50-00:48:29",
    ...
    const output = this.solution(inputPlayTime, inputAdvTime, inputLogs);

    // test();
    console.log(
      `Input: ${inputPlayTime} ${inputAdvTime}\n${inputLogs.join("\n")}`
    );
