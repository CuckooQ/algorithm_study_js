...

{
    ...
    function testToLimitMaxWeight() {
        ...
        const condition = (testFunction(inputLimitWeight, inputDogWeights) === expectResult);    
    ...
    function testToLimitMinWeight() {
        ...
        const inputDogWeights = [MIN_LIMIT_WEIGHT, MIN_LIMIT_WEIGHT, MIN_LIMIT_WEIGHT, MIN_LIMIT_WEIGHT];
