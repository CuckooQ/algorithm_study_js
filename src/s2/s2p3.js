 ...
 */
{
    class RockScissorPaperUser {
        ...
        isWin(opponent) {
            ...
            if (mySelection === this.ROCKSCISSORPAPER.SCISSOR && oppSelection === this.ROCKSCISSORPAPER.PAPER) {
                return true;
            } else if (mySelection === this.ROCKSCISSORPAPER.ROCK && oppSelection === this.ROCKSCISSORPAPER.SCISSOR) {
                return true;
            } else if(mySelection === this.ROCKSCISSORPAPER.PAPER && oppSelection === this.ROCKSCISSORPAPER.ROCK){
                return true;
            } else {
                return false;
            }
