...

{
  ...
  function isRazor(info, prevInfo) {
    return info === RIGHT_PARENTHESIS && prevInfo === LEFT_PARENTHESIS;
  }

  function isBarStart(info, prevInfo) {
    return info === LEFT_PARENTHESIS && prevInfo === LEFT_PARENTHESIS;
  }

  function isBarEnd(info, prevInfo) {
    return info === RIGHT_PARENTHESIS && prevInfo === RIGHT_PARENTHESIS;
  }
